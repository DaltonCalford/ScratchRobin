...
// MySQL System Catalog and Metadata Support
class MySQLCatalog {
public:
...
// MySQL Query Builder for common operations
...
// MySQL Data Type Mapper
class MySQLDataTypeMapper {
public:
    // Map MySQL types to generic types
    static QString mapToGenericType(const QString& mysqlType);
...
// MySQL Backup and Restore Manager
...
public:
    ...
    static QString getEnterpriseBackupQuery();
};
