...
// MariaDB System Catalog and Metadata Support
...
public:
    ...
    static QString getSystemVariablesQuery();
};

// MariaDB Query Builder for common operations
...
public:
    ...
    static QString buildAddVirtualColumnQuery(const QString& tableName, const QString& columnName,
                                            const QString& expression, const QString& dataType,
                                            const QString& schema = "", const QString& database = "");

    // Sequence operations
    static QString buildCreateSequenceQuery(const QString& sequenceName, qint64 startValue = 1, qint64 increment = 1,
                                          qint64 maxValue = 9223372036854775807LL,
                                          const QString& schema = "", const QString& database = "");
    static QString buildDropSequenceQuery(const QString& sequenceName, const QString& schema = "", const QString& database = "");
...
// MariaDB Data Type Mapper
class MariaDBDataTypeMapper {
public:
    // Map MariaDB types to generic types
    static QString mapToGenericType(const QString& mariadbType);
...
// MariaDB Security Manager
class MariaDBSecurityManager {
public:
...
public:
    ...
    static QString buildMariabackupCommand(const QString& database, const QString& backupDir,
                                         const QString& username, const QString& password,
                                         const QString& host = "localhost", int port = 3306);
...
// MariaDB Performance Monitor
class MariaDBPerformanceMonitor {
public:
