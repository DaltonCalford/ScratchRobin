 ...
 */
#ifndef SCRATCHROBIN_TABLE_DESIGNER_FRAME_H
#define SCRATCHROBIN_TABLE_DESIGNER_FRAME_H
...
class TableDesignerFrame : public wxFrame {
public:
    TableDesignerFrame(WindowManager* windowManager,
...
#endif // SCRATCHROBIN_TABLE_DESIGNER_FRAME_H
