...
5. Full type mapping (JSON, JSONB: `scratchbird.types.Jsonb`, RANGE: `scratchbird.types.Range`, GEOMETRY: `scratchbird.types.Geometry`, arrays, UUID, vector, network, spatial).
