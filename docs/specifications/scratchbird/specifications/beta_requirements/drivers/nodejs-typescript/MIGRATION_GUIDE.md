...
Wrapper types: JSONB uses `ScratchbirdJsonb`, RANGE uses `ScratchbirdRange<T>`, GEOMETRY uses `ScratchbirdGeometry`. Use these wrappers when binding parameters or reading results.
