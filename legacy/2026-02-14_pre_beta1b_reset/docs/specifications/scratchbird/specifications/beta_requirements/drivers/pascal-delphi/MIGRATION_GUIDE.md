...
Wrapper types: JSONB uses `TScratchBirdJsonb`, RANGE uses `TScratchBirdRange`, GEOMETRY uses `TScratchBirdGeometry`. Use these wrappers when binding parameters or reading results.
