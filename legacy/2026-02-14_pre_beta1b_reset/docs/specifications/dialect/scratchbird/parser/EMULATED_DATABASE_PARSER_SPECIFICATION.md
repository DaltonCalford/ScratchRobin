...
## References
- `docs/specifications/dialect/scratchbird/catalog/SCHEMA_PATH_RESOLUTION.md`
...
See `docs/specifications/dialect/scratchbird/catalog/SCHEMA_PATH_RESOLUTION.md` for authoritative path resolution rules
