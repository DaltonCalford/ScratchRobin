...
- **Data Views**: Embedded query results with refresh + staleness indicators
...
- Password policy wizard with SQL output
- Login lockout, role switch, policy epoch, and audit log viewers
...
- **[planning/OFFLINE_EXECUTION_CHECKLIST.md](planning/OFFLINE_EXECUTION_CHECKLIST.md)** - Focused offline execution checklist
- **[specifications/reporting/README.md](specifications/reporting/README.md)** - Reporting & live analytics specs
...
# Default suite (smoke + unit, <= 15 minutes target)
./tests/run_tests.sh
```

For full test options, see `tests/README.md`.
...
| Whiteboard | ✅ Complete | 3 |
| Mind Maps | ✅ Complete | 3 |
| Data Flow Diagrams | ✅ Complete | 3 |
...
| Documentation System | 🔄 In Progress | 8 |
| Git Integration | 🔄 In Progress | 11 |
