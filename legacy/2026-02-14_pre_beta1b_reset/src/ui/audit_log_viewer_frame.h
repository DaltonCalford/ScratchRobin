 ...
 */
#ifndef SCRATCHROBIN_AUDIT_LOG_VIEWER_FRAME_H
#define SCRATCHROBIN_AUDIT_LOG_VIEWER_FRAME_H
...
class AuditLogViewerFrame : public wxFrame {
public:
    AuditLogViewerFrame(WindowManager* windowManager,
                        ConnectionManager* connectionManager,
                        const std::vector<ConnectionProfile>* connections,
                        const AppConfig* appConfig);
    ~AuditLogViewerFrame() override;
...
#endif // SCRATCHROBIN_AUDIT_LOG_VIEWER_FRAME_H
