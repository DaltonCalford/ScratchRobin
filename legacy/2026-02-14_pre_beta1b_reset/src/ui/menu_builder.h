...
/**
 * @brief Build a minimal menu bar for child/tool windows.
 * 
 * Contains only File (Close) and Help menus.
 * Use this for manager frames, dialogs, and tool windows
 * instead of the full menu bar.
 */
