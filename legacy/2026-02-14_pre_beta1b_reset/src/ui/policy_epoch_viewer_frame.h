 ...
 */
#ifndef SCRATCHROBIN_POLICY_EPOCH_VIEWER_FRAME_H
#define SCRATCHROBIN_POLICY_EPOCH_VIEWER_FRAME_H
...
class PolicyEpochViewerFrame : public wxFrame {
public:
    PolicyEpochViewerFrame(WindowManager* windowManager,
                           ConnectionManager* connectionManager,
                           const std::vector<ConnectionProfile>* connections,
                           const AppConfig* appConfig);
    ~PolicyEpochViewerFrame() override;
...
#endif // SCRATCHROBIN_POLICY_EPOCH_VIEWER_FRAME_H
