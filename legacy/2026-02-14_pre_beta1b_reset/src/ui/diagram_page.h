...
private:
    ...
    void OnRefreshDataViews(wxCommandEvent& event);
    void OnRefreshSingleDataView(wxCommandEvent& event);
    void OnDataViewUpdated(wxCommandEvent& event);
    void OnOpenDataViewEditor(wxCommandEvent& event);
    ...
    void UpdateDataViewStatus();
    void SyncDataViewsToCanvas();
    ...
    wxStaticText* data_view_status_label_ = nullptr;
