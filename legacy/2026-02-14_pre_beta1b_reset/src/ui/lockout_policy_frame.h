 ...
 */
#ifndef SCRATCHROBIN_LOCKOUT_POLICY_FRAME_H
#define SCRATCHROBIN_LOCKOUT_POLICY_FRAME_H
...
class LockoutPolicyFrame : public wxFrame {
public:
    LockoutPolicyFrame(WindowManager* windowManager,
                       ConnectionManager* connectionManager,
                       const std::vector<ConnectionProfile>* connections,
                       const AppConfig* appConfig);
    ~LockoutPolicyFrame() override;
...
#endif // SCRATCHROBIN_LOCKOUT_POLICY_FRAME_H
