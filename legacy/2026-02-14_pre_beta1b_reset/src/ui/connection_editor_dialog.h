...
private:
    ...
    wxCheckBox* status_auto_poll_check_ = nullptr;
    wxTextCtrl* status_poll_interval_ctrl_ = nullptr;
    wxChoice* status_default_choice_ = nullptr;
    wxTextCtrl* status_category_order_ctrl_ = nullptr;
    wxTextCtrl* status_category_filter_ctrl_ = nullptr;
    wxCheckBox* status_diff_enabled_check_ = nullptr;
