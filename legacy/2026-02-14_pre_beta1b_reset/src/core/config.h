...
// UiChromeConfig with proper defaults for child windows
struct UiChromeConfig {
    WindowChromeConfig mainWindow;        // Full menu
    WindowChromeConfig sqlEditor{true, true, false, false};      // No menu replication
    WindowChromeConfig monitoring{true, true, false, false};     // No menu replication  
    WindowChromeConfig usersRoles{true, true, false, false};     // No menu replication
    WindowChromeConfig diagram{true, true, false, false};        // No menu replication
};
...
public:
    ...
    bool SaveConnections(const std::string& path, const std::vector<ConnectionProfile>& connections);
