 ...
 */
#ifndef SCRATCHROBIN_ISSUE_TRACKER_GITLAB_H
#define SCRATCHROBIN_ISSUE_TRACKER_GITLAB_H
...
// ============================================================================
class GitLabAdapter : public IssueTrackerAdapter {
public:
    static constexpr const char* PROVIDER_NAME = "gitlab";
    
    ~GitLabAdapter() override = default;
...
private:
    ...
    IssueStatus ParseGitLabState(const std::string& state);
    std::string StatusToGitLab(IssueStatus status);
};

} // namespace scratchrobin

#endif // SCRATCHROBIN_ISSUE_TRACKER_GITLAB_H
